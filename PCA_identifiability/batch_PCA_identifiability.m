...
[Idiff_orig,Ident_mat_orig,Idiff_recon,Idiff_opt,recon_matrix_opt,Ident_mat_recon_opt,PCA_comps_range,m_star]  = f_PCA_identifiability(orig_matrix,Test_index,Retest_index,configs);
